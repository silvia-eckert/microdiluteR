...
Creating this package was a lot of work, and I made it available for free. If you use this package for your publication, be fair and cite it, e.g. using the following BibTeX entry:
```{r, eval = FALSE}
@Manual(
  title    = {microdiluteR},
